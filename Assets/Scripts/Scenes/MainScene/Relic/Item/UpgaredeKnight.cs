...
namespace Scenes.MainScene.Relic.Item
{
    public class UpgaredeKnight : RelicItemBase
    {
        public override void Init()
        {
            ...
            var Sowrdman = Resources.Load<CardPool>("Value/RewardUnitPool").cards.FirstOrDefault(c => c.status.name == "歩兵");
            var HorceKnight = Resources.Load<CardPool>("Value/RewardUnitPool").cards.FirstOrDefault(c => c.status.name == "騎兵");
